...
const form = useForm({
    ...
    is_private: props.venue?.is_private,
    is_active: props.venue?.is_active,
    staff_id: props.venue?.staff_id,
});
</script>

<template>
    <Head title="Venue edit" />
        ...
        <template #header>
            ...
            <nav class="w-full rounded-md">
                <ol class="list-reset flex">
                    ...
                    <li class="text-neutral-500 dark:text-neutral-400">View</li>
                </ol>
            </nav>
        </template>
                            ...
                            <div class="grid gap-6 mb-6 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    >
                                        <option :value="props.venue?.staff_id">
                                            {{ props.venue?.staff?.name }}
                                        </option>
                                    </select>
                                </div>
